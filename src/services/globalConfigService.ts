import { DEFAULT_BRANCH_NAME, StorageTypes, UriTypes } from '../types.js'
// import * as EventBus from '../../common/global-event-bus'
import { incrementFilename, generateGuid, joinUrls, pick, typeOfUri } from '../helpers.js'
...
export default class GlobalConfigService {
    ...
    async get(): Promise<GlobalConfig> {
        ...
        //     if (!config.xdaiProviderUrl)
        //         config.xdaiProviderUrl = this.getInitialConfig().xdaiProviderUrl
    ...
    getInitialConfig(): GlobalConfig {
        ...
        config.swarmPostageStampId =
            '983601c2e0c8fedfe97ac316d51269f56c3ff99004b10bbd9bcdf8077200f32f'
